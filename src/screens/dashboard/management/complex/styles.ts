...
export const complexStyles = StyleSheet.create({
  layoutContent: {
    paddingBottom: 120,
  },
  screen: {
  ...
  settingsMetaChipLight: {
    backgroundColor: '#f8fafc',
    borderColor: '#dbe4ef',
  },
  settingsMetaChipDark: {
    backgroundColor: '#18181b',
    borderColor: '#303036',
  },
  settingsMetaChipActive: {
    borderColor: '#16a34a',
  ...
  settingsSectionCardLight: {
    backgroundColor: '#f8fafc',
    borderColor: '#dbe4ef',
  },
  settingsSectionCardDark: {
    backgroundColor: '#18181b',
    borderColor: '#303036',
  },
  ...
  detailActionPanelLight: {
    backgroundColor: '#f8fafc',
    borderColor: '#dbe4ef',
  },
  detailActionPanelDark: {
    backgroundColor: '#17171b',
    borderColor: '#303036',
  },
  detailActionPanelTitle: {
    fontSize: 11,
    fontFamily: 'WorkSans-Bold',
    textTransform: 'uppercase',
    letterSpacing: 0.55,
  ...
  screenActionBackButton: {
    flex: 1,
    justifyContent: 'flex-start',
    paddingHorizontal: 14,
  },
  screenActionBackButtonLight: {
    backgroundColor: '#ffffff',
    borderColor: '#dbe4ef',
  },
  screenActionBackButtonDark: {
    backgroundColor: '#11141b',
    borderColor: '#303036',
  },
  ...
  screenActionGlassText: {
    color: '#0f172a',
    fontSize: 13,
    fontFamily: 'WorkSans-Bold',
  },
  screenActionGlassTextDark: {
    color: '#dbeafe',
  },
  modalFooter: {
    flexDirection: 'row',
  ...
  settingsOptionButtonActiveDark: {
    backgroundColor: '#1e3a8a',
    borderColor: '#60a5fa',
  },
  settingsOptionButtonPremiumLight: {
    shadowColor: '#2563eb',
    shadowOpacity: 0.2,
    shadowRadius: 8,
    shadowOffset: { width: 0, height: 3 },
  ...
  settingsOptionButtonPremiumDark: {
    shadowColor: '#93c5fd',
    shadowOpacity: 0.35,
    shadowRadius: 9,
    shadowOffset: { width: 0, height: 4 },
