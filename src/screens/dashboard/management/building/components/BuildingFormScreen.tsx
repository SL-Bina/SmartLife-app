...
import { ArrowLeft, BadgeCheck, Building2, Hash, MapPinned, Save } from 'lucide-react-native';

import { buildingStyles as styles } from '../styles';
import { EntityItem, BuildingFormState } from '../types';

type BuildingFormScreenProps = {
  isDark: boolean;
        ...
        <View style={styles.formScreenBody}>
          ...
          >
            ...
            <View style={[styles.formFieldBlock, styles.formFieldBlockModern, isDark ? styles.formFieldBlockDark : styles.formFieldBlockLight]}>
              <Text style={[styles.formFieldLabel, isDark ? styles.textMutedDark : styles.textMutedLight]}>Bina adi</Text>
              <TextInput
            ...
            <View style={[styles.formFieldBlock, styles.formFieldBlockModern, isDark ? styles.formFieldBlockDark : styles.formFieldBlockLight]}>
              <Text style={[styles.formFieldLabel, isDark ? styles.textMutedDark : styles.textMutedLight]}>Complex ID</Text>
              <View style={styles.detailHeaderRow}>
                <Hash size={14} color={isDark ? '#a1a1aa' : '#64748b'} strokeWidth={2.1} />
                <TextInput
                  value={formState.complexId}
                  onChangeText={value => onChange({ complexId: value })}
                  placeholder="1"
                  placeholderTextColor={placeholderColor}
            ...
            <View style={[styles.formFieldBlock, styles.formFieldBlockModern, isDark ? styles.formFieldBlockDark : styles.formFieldBlockLight]}>
              ...
              <View style={styles.detailHeaderRow}>
                <MapPinned size={14} color={isDark ? '#a1a1aa' : '#64748b'} strokeWidth={2.1} />
              </View>
              <TextInput
