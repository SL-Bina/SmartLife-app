      ...
      <View style={[styles.body, { backgroundColor: theme.bodyBg, borderColor: theme.bodyBorder }]}>
        ...
        <View style={styles.headerRow}>
          <View style={styles.textWrap}>
            ...
            <Text style={[styles.title, { color: theme.title }]}>Binalar</Text>
            <Text style={[styles.subtitle, { color: theme.subtitle }]}>Bina siyahısı, yarat / elave et / sil</Text>
        ...
        <View style={styles.searchGroup}>
                  ...
                  return (
                    <Pressable
                      ...
                      style={[
                        styles.selectOption,
                        isSelected
                          ? { backgroundColor: isDark ? 'rgba(59,130,246,0.26)' : '#dbeafe' }
                          : null,
                      ]}
                    >
                      <Text
          ...
          <TextInput
            ...
            placeholder="Bina adi ile axtar"
