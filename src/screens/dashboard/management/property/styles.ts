...
export const propertyStyles = StyleSheet.create({
  ...
  detailBalanceCardLight: {
    borderColor: '#dbe4ef',
    backgroundColor: '#f8fafc',
  },
  detailBalanceCardDark: {
    borderColor: '#303036',
  ...
  detailBalanceIconWrapLight: {
    backgroundColor: '#dcfce7',
    borderColor: '#bbf7d0',
  },
  detailBalanceIconWrapDark: {
    backgroundColor: 'rgba(20, 83, 45, 0.3)',
    borderColor: 'rgba(22, 163, 74, 0.5)',
  },
  detailBalanceTextWrap: {
    flex: 1,
    gap: 3,
  },
  detailBalanceLabel: {
  ...
  detailBalanceValueLight: {
    color: '#15803d',
  },
  detailBalanceValueDark: {
    color: '#86efac',
  },
  detailActionPanel: {
    marginTop: 12,
  ...
  screenActionsRowFourCol: {
    justifyContent: 'space-between',
  },
  screenActionsRowFiveCol: {
    justifyContent: 'space-between',
  },
  screenActionButton: {
    minHeight: 46,
