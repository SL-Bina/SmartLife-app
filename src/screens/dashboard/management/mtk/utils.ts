...
export const getMtkName = (item: EntityItem): string => {
  ...
  return id === null ? 'Adsiz MTK' : `MTK #${id}`;
};

export const getMtkSecondary = (item: EntityItem): string => {
...
export const buildPayload = (form: MtkFormState): Record<string, unknown> => {
