...
import { asText, getMtkName, normalizeDateTime, pickMeta, statusToLabel } from '../utils';

type MtkViewScreenProps = {
    isDark: boolean;
...
export function MtkViewScreen({ isDark, item, onClose, onEdit, onDelete }: MtkViewScreenProps) {
    ...
    const identityRows: ViewRow[] = [
        { key: 'name', label: 'Ad', value: item ? getMtkName(item) : '-', icon: Building2 },
