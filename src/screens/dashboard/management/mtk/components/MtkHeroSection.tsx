...
export function MtkHeroSection({
  isDark,
  totalItems,
  search,
  error,
      ...
      <View style={[styles.body, { backgroundColor: theme.bodyBg, borderColor: theme.bodyBorder }]}>
        ...
        <View style={styles.headerRow}>
          <View style={styles.textWrap}>
            ...
            <Text style={[styles.title, { color: theme.title }]}>MTK</Text>
            <Text style={[styles.subtitle, { color: theme.subtitle }]}>MTK siyahısı, yarat / elave et / sil</Text>
