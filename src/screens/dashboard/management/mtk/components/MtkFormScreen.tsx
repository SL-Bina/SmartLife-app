...
import { EntityItem, MtkFormState } from '../types';

type MtkFormScreenProps = {
  isDark: boolean;
  editingItem: EntityItem | null;
  formState: MtkFormState;
  submitting: boolean;
  onChange: (patch: Partial<MtkFormState>) => void;
  onClose: () => void;
  onSubmit: () => void;
};

export function MtkFormScreen({
  isDark,
  editingItem,
  formState,
  submitting,
        ...
        <View style={styles.formScreenBody}>
          ...
          >
            ...
            <View style={styles.detailHeaderRow}>
              ...
              <View style={styles.detailHeaderTextWrap}>
                <Text style={[styles.detailHeaderTitle, isDark ? styles.textPrimaryDark : styles.textPrimaryLight]}>
                  {editingItem ? 'MTK Yenile' : 'Yeni MTK Elave Et'}
                </Text>
            ...
            <View style={[styles.formFieldBlock, styles.formFieldBlockModern, isDark ? styles.formFieldBlockDark : styles.formFieldBlockLight]}>
              <Text style={[styles.formFieldLabel, isDark ? styles.textMutedDark : styles.textMutedLight]}>MTK adi</Text>
              <TextInput
